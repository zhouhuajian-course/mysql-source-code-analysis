...
-DWITH_DEBUG=1 \
-DWITHOUT_CSV_STORAGE_ENGINE=0 \
-DWITHOUT_BLACKHOLD_STORAGE_ENGINE=0 \
-DWITHOUT_FEDERATED_STORAGE_ENGINE=0 \
-DWITHOUT_ARCHIVE_STORAGE_ENGINE=0 \
-DWITHOUT_MRG_MYISAM_STORAGE_ENGINE=0 \
